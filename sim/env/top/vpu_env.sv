...
class vpu_env extends uvm_env;
	...
	virtual function void build_phase(uvm_phase phase);
		...
		uvm_config_db #(uvm_object_wrapper)::set(this, {req_agt.get_name(), ".", "sqr.main_phase"}, "default_sequence", req_packet_sequence::get_type());
		rsp_agt = rsp_agent::type_id::create("rsp_agt", this);
